...
<h2 align="center"> View Employee Reports </h2>
...
%>
    <table width="80%" border="1" align="center">
      <tr>
        <td width="27%" class="btn-primary">Sno</td>
        <td width="34%" class="btn-primary">Emp ID </td>
        <td width="39%" class="btn-primary">Time</td>
      </tr>
      <%
  int i=0;
  while(rs.next())
