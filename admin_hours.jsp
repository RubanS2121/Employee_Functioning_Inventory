...
{
%>
  <a href="admin_hours.jsp?act=cin"><img src="img/clockin.jpg" /></a>
  <%
}
else 
{
%>
  <a href="admin_hours.jsp?act=cout"><img src="img/clockout.jpg" /></a>
  <%
}
...
String act=request.getParameter("act");
	...
	String qry = "select max(id) as maxid from efi_hours";
                    ...
                    int id2 = id1 + 1;
	String ins="insert into efi_hours(id,utype,empid,rdate,stime,etime,thours,status) values("+id2+",'HR','"+uname+"','"+rdate1+"','"+stime+"','','','0')";	
	int n=stmt.executeUpdate(ins);
        response.sendRedirect("admin_hours.jsp");
	}
	else 
	{
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td align="right"><a href="add_adjust.jsp">Adjustment</a></td>
    </tr>
  </table>
  <p align="right">&nbsp;</p>
