...
String btn=request.getParameter("btn");
	...
	ResultSet rs=stmt.executeQuery("select * from efi_task where empid='"+empid+"'");
%>
  <table width="80%" border="1" align="center">
    <tr>
      <td width="6%" class="btn-primary">Sno</td>
      <td width="26%" class="btn-primary">Emp ID </td>
