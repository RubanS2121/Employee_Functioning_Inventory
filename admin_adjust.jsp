...
String tid=request.getParameter("tid");
	...
	%>
					...
					window.location.href="admin_adjust.jsp";
					</script>
					<%
...
ResultSet rs=stmt.executeQuery("select * from efi_adjust where utype='EMP'");
 %>
...
<form id="form1" name="form1" method="post" action="">
  ...
  %>
	...
	{
	%>
	<a href="admin_adjust.jsp?act=yes&tid=<%=rs.getInt("id")%>">Accept</a> / 
	<a href="admin_adjust.jsp?act=no&tid=<%=rs.getInt("id")%>">Decline</a>
	<%
	}
	%>      </td>
    </tr>
