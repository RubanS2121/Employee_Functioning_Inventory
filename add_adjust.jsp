...
String btn=request.getParameter("btn");
 ...
 String ins = "insert into efi_adjust(id,utype,empid,sdate,stime,edate,etime,detail,status) values('"+id2+"','HR','"+uname+"','"+sdate+"','"+stime+"','"+edate+"','"+etime+"','"+detail+"','0')";
                    //out.print(ins);
					...
					window.location.href="admin_adjust_st.jsp?act=success";
					</script>
					<%
					}
